    ...
    <div class="row">
        <div class="col-12 mb-3">
            <div class="row align-items-center atas">
                <div class="col-md-1">
                    <button type="button" class="btn-back" onclick="window.history.back();"><i class="bi bi-arrow-left-circle"></i></button>
                </div>
                <div class="col-md-7">
                    <div class="text">
                        <h1>LIST CATALOG</h1>
                    ...
                    <div class="row">
                        @foreach($properties as $property)
                            <div class="col-md-4 mb-4">
                                <a href="{{ route('properties.show', $property->id) }}" style="text-decoration: none; color: inherit;">
                                    <div class="card cust-card">
                                        <div class="card-img-top" 
                                             style="background-image: url('{{ asset('img/' . $property->image) }}'); height: 250px; background-size: cover; background-position: center;">
                                            <span class="badge position-absolute p-2" style="top: 15px; left: 15px; text-transform: uppercase;">
                                                {{ $property->status }}
                                            </span>
                                        </div>
                                        <div class="card-body">
